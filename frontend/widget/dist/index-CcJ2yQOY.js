...
async function Ll({ hash: e, signature: t }) {
  const n = nt(e) ? e : Hn(e), { secp256k1: r } = await import("./secp256k1-BD9Zc1GK.js");
  return `0x${(() => {
...
async function _f(e, t) {
  ...
  try {
    ...
    const Y = oh(j), { offchainLookup: _, offchainLookupSignature: O } = await import("./ccip-BtT-CeRs.js");
