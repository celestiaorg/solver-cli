...
impl QuoteGenerator {
	...
	async fn build_permit2_domain_object(
		...
		use crate::server::apis::quote::registry::PROTOCOL_REGISTRY;
	...
	fn build_permit2_message_object(
		...
		use crate::server::apis::quote::permit2::build_permit2_batch_witness_digest;
...
mod tests {
	use super::*;
	use crate::server::apis::quote::custody::CustodyDecision;
